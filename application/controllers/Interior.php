...
class Interior extends CI_Controller {
	...
	*/
    ...
    // Pagination configuration
		$config['base_url'] = base_url('produk/interior/index');
		$config['total_rows'] = $this->Mproduk->get_total_produk("Interior");
		$config['per_page'] = 6;
    ...
    // Get interior with pagination
		$page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
		$data['interior'] = array(); // Initialize as empty array
		$data['interior'] = $this->Mproduk->get_produk_produk($config['per_page'], $page, "Interior");
		// Log the fetched data for debugging
		log_message('debug', 'Fetched interior data: ' . print_r($data['interior'], true));


    // Load baliho list view
		$this->load->view('view_header');
		$this->load->view('vinteriorlist', $data);
	...
	public function view($slug = NULL){
        $data['interior'] = $this->Mproduk->get_produk_view($slug);
        ...
        // $data['title'] = $data['interior_item']['title'];

		$this->load->view('view_header');
        $this->load->view('vinterior', $data);
		$this->load->view('view_footer');
